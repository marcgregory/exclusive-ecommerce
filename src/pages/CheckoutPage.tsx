  ...
  return (
    <main className="container page">
      ...
      <form className="checkout-form" onSubmit={submit}>
        ...
        <div><OrderSummary cart={cart} /><Button type="submit" disabled={submitting}>{submitting ? "Placing Order..." : "Place Order"}</Button>{status && <p className={`form-status ${statusIsError ? "form-status--error" : ""}`}>{status}</p>}</div>
      </form>
    </main>
  );
}
